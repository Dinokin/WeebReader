    ...
    public class MariaDbContext : BaseContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Title>(typeBuilder =>
            {
                ...
                typeBuilder.Property(title => title.Version).HasColumnType("BIGINT UNSIGNED");
            });
            ...
            builder.Entity<NovelChapter>(typeBuilder => typeBuilder.Property(chapter => chapter.Content).HasColumnType("MEDIUMTEXT"));
