...
namespace WeebReader.Data.Contexts.Migrations
{
    ...
    [Migration("20200828102527_RemoveTitleVersion")]
    partial class RemoveTitleVersion
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("WeebReader.Data.Entities.NovelChapterContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("WeebReader.Data.Entities.NovelPage", b =>
                {
                    ...
                    b.HasIndex("ChapterId")
                        .HasDatabaseName("IX_Pages_ChapterId1");
            ...
            modelBuilder.Entity("WeebReader.Data.Entities.NovelChapterContent", b =>
                {
                    b.HasOne("WeebReader.Data.Entities.NovelChapter", "Chapter")
                        .WithOne("NovelChapterContent")
                        .HasForeignKey("WeebReader.Data.Entities.NovelChapterContent", "ChapterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WeebReader.Data.Entities.NovelPage", b =>
                {
                    b.HasOne("WeebReader.Data.Entities.NovelChapter", "Chapter")
                        .WithMany("Pages")
                        .HasForeignKey("ChapterId")
                        .HasConstraintName("FK_Pages_Chapters_ChapterId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
        }
